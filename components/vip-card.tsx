...
export default function VipCard({
  ...
  return (
    <div
      className={cn(
        "shine-effect relative w-full overflow-hidden rounded-lg p-4 text-white shadow-xl",
        className
      )}
    >
      {/* Background Image */}
      ...
      <div className="relative z-10 flex items-center gap-3">
        ...
        <div className="shrink-0">
          ...
          />
          <span className="text-lg pl-1 font-semibold text-yellow-400">
            VIP {level}
          </span>
        </div>
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-baseline pl-12 gap-2 mb-1">
            <span className="text-sm pl-8 text-right font-medium text-white">
              {levelNames[level]}
            </span>
          </div>
