...
const PromoVipPage = () => {
  ...
  return (
    <div
      className="min-h-screen pb-20 bg-[#450b00]"
        ...
        {activeTab === "promo" ? (
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-2 mb-6">
              {/* Upgrade Bonus */}
              <Card className="p-4    border-game-burgundy h-24">
            ...
            <div className="w-full -mx-4">
                ...
                <table className=" w-full text-xs">
                  <thead>
                    <tr className="border-b text-white border-game-burgundy bg-game-burgundy/30">
                      <th className="text-left p-1 text-game-gold font-medium">
                        Level
                      </th>
                      <th className="text-left p-1 text-game-gold font-medium">
                        Deposit
                  ...
                  <tbody>
                    {vipLevels.map((level, index) => (
                      <tr
                        key={index}
                        className="border-b border-game-burgundy/30 hover:bg-game-burgundy/20"
                      >
              ...
              <div className="mt-4 px-4 text-xs text-white space-y-1">
                <p>
                  • Level-Up Bonus - Recharge to reach a new VIP level and get
                  the bonus.
                </p>
                <p>
                  • Weekly Bonus - Last week's recharge ≥ 10x weekly bonus.
                  Claim from Monday.
                </p>
                <p>
                  • Monthly Bonus - Last month's recharge ≥ 10x monthly bonus.
                  Claim from 1st.
                </p>
